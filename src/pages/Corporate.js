...
const Corporate = () => {
  return (
    <div>
      <Helmet>
        <title>Fil Pharma - Hakkımızda</title>
        <meta name="description" content="Fil Pharma hakkında bilgi edinin. 2005 yılında kurulan Fil Pharma, medikal sağlık sektöründe yenilikçi ve güvenilir çözümler sunar. Ürünlerimiz, yüksek standartlarda kalite ve etkinliği garanti eder." />
      </Helmet>
